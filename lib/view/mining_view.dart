      ...
      return Scaffold(
        ...
        body: Stack(
          children: [
            ...
            Consumer2<MiningViewViewModel, CoinsViewModel>(
                builder: (context, provider, coin, child) {
                  ...
                  : CustomScrollView(
                      slivers: [
                        SliverAppBar(
                          ...
                          centerTitle: true,
                          pinned: false, // Keep the AppBar visible at the top
                        ...
                        SliverToBoxAdapter(
                          child:
                              (kBottomNavigationBarHeight + 20).verticalSpace,
                        )
                      ],
                    );
            }),
